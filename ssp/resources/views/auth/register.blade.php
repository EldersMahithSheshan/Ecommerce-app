...
<head>
  ...
  <title>ClickChic Register</title>
  ...
  <div class="container">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <!-- Hardcode image directly in the div with inline CSS -->
          <div class="col-lg-5 d-none d-lg-block" style="background: url('/admin_assets/img/2 2.png'); background-position: center; background-size: cover;"></div>
          <div class="col-lg-7">
            <div class="p-5">
